...
import requests, re, datetime, json, random, sys
from DB_handler import DBModule
from werkzeug.security import generate_password_hash, check_password_hash
import http.client
from tosspaymentsApi import getBase64Str, getPayment, getCancel
...
word_list1 = ["광역", "국물", "가라", "밑천", "음경", "에로", "매장", "진상", "가사", "에다", "먹구", "시신",
              "수세", "매신", "와장", "도소", "아만", "가달", "가면", "가수", "가장", "간이", "걱정", "고대", "지하", "소도", "음핵",
              "고부", "고생", "고시", "구나", "구매", "구입", "내기", "년", "다양", "산소", "씨", "실성", "비엘",
              "대해", "도각", "라고", "만만", "만시", "무리", "디스", "일수", "보다", "부러", "부족", "진무", "핸플",
              "불편", "비하", "비해", "비할", "빠", "생기", "세워", "세하", "적당", "닷지", "원분", "인분",
              "새가", "시기", "실천", "아니", "않", "야한", "야해", "어보", "영구", "요구", "용하", "이반", "텐가", "대딸",
              "원해", "의가", "의경", "의세", "의시", "이도", "이신", "이조", "반정", "독점", "당한", "속되", "동침",
              "이자", "인마", "임마", "전부", "제대", "주세", "주전", "참수", "음문", "해보", "포대", "주시",
              "지주", "체적", "하자", "한부", "한사", "해본", "한독", "한자", "고신", "고소", "도기", "뒤지", "포열",
              "맞", "오고", "고보", "고장", "인사", "인생", "정사", "수해", "살해", "음해", "해적", "장해", "유해", "음부", "위하",
              "추지", "거지", "지휘", "보지", "자지", "가지", "주사", "주성", "기가", "기만", "사기", "성기", "기생", "구수",
              "양이", "요리", "예리", "울인", "저것", "저해", "도추", "설도", "성교", "교접", "교미", "교구", "방지", "구원", "먹",
              "사소", "방사", "사단", "사살", "교합", "구합", "시체", "시한", "지시", "강간", "간판", "수간", "간사", "이시", "뒤져",
              "시간", "요런", "고런", "다운", "바보", "바람", "건너", "자살", "자위", "위기", "위선", "가격", "가해", "도부", "지발",
              "가오", "가추", "아다", "빠가", "씹", "한거", "지가", "야기", "요사", "인하", "가하", "대신", "냉", "뒤졌", "야캠",
              "우가", "요이", "이상", "이란", "여전", "가보", "고단", "공유", "냄새", "간음", "일하", "취의", "정성",
              "살생", "살육", "참고", "테러", "해도", "난자", "고문", "가금", "지부", "전주", "가조", "간부", "나체", "도사",
              "색사", "색정", "여색", "다음", "이기", "색상", "수사", "타공", "수도", "자인", "보도", "분골", "등선",
              "너무", "다전", "당연", "요요", "유하", "은조", "이부", "주문", "이슬", "음모", "가질", "사문", "전시",
              "페이", "주가", "치도", "판매", "알선", "황인", "걸레", "처음처럼", "청하", "시음", "야비",
              "인기", "과도", "다주", "술", "요가", "탄하", "전작", "장도", "도편", "성인", "야할", "고해",
              "이온", "이혼", "대한", "한가", "고객", "차우", "해당", "서고", "설정", "등신", "도해", "대형", "상선", "명목",
              "독살", "장살", "투살", "활살", "폐시", "생살", "노체", "콘돔", '블로그마케팅', '뇌피셜',
              "구살", "진살", "거열", "유살", "금진", "공살", "늑사", "진살", "방살", "답살", "진살", "방살", "흉살", "교륙",
              "진륙", "참륙", "경살", "죽살", "늑살", "한살", "격살", "추살", "분살", "육좌", "추살", "안살", "시륙", "금참", "불구",
              "상명", "추살", "찬살", "족살", "충살", "장살", "즉살", "독시", "낙살", "짐살", "짐시", "참간", "중살", "색녀",
              "납살", "천살", "오역", "즉참", "겁살", "암자", "폭살", "책살", "습살", "확탕", "확팽", "남살", "화살", "의살", "교사",
              "도둑", "도적", "죄악", "악덕", "구도", "숙적", "소악", "행악", "도인", "투아", "적도", "사고", "악당", "악작", "음탕",
              "거악", "대범", "상륜", "수죄", "역절", "중범", "교죄", "도범", "간죄", "고범", "전범", "음질", "임질", "행간", "행음",
              "혼음", "범간", "윤간", "능욕", "폭행", "추행", "승간", "야바", "아편", "중독", "약질", "겁탈", "오입", "애액", "외입",
              "음간", "겁측", "혼간", "흘레", "잡혼", "난혼" "독음", "통간", "행방", "성희", "발정", "애분", "퀴어", "일탈", "가매",
              "치사", "살인", "간당", "매춘", "치폐", "치명", "재생", "매색", "사지", "음매", "매혈", "밀수", "매약", "난사", "거유",
              "밀매", "고주", "투매", "잠매", "사매", "매주", "주매", "콜걸", "창녀", "창부", "창기", "유녀", "막창", "춘부", "화랑",
              "살꽃", "달첩", "색주", "행창", "흥녀", "포주", "매미", "홀복", "화방", "기방", "침노", "사범", "조폭", "납치", "매승",
              "양주", "주색", "작부", "백주", "독주", "주류", "취사", "말술", "탁주", "술독", "축배", "울창", "낮술",
              "곡주", "밀주", "취한", "청작", "녹주", "경주", "야양", "일주", "예주", "배주", "권주", "노주", "맛술", "서주", "약술",
              "통술", "준주", "춘주", "사주", "세주", "설술", "가양", "가주", "감주", "박차", "벽주", "밑술", "강주", "쌍술", "노출",
              "뒷술", "야작" "만작", "법주", "특주", "상주", "밤술", "젯술", "신주", "명주", "벌술", "벌주", "짐주", "묘주", "촌주",
              "토주", "귤술", "귤주", "타주", "공주", "자주", "족주", "유주", "꽃술", "계주", "병술", "뇌주", "벌작", "방준",
              "배술", "홧술", "옥주", "찬술", "냉주", "명술", "생술", "주렵", "엽주", "호주", "맞술", "초주", "입주", "선술", "객주",
              "후주", "수주", "궁온", "순주", "전술", "순료", "보쌈", "국수", "구인", "비수", "서절", "정인", "모주", "우인", "피천",
              "우자", "미동", "연동", "연관", "연세", "서리", "할퀴다", "도취", "절취", "투도", "악구", "험구", "사음", "투절",
              "나이프", "보검", "도자", "패도", "총검", "양도", "발도", "족보", "패검", "단칼", "비도", "명검", "성검", "단도", "발검",
              "쾌도", "단검", "쌍검", "삼척", "접칼", "장검", "고검", "간로", "용검", "은도", "소검", "운검", "장창", "손칼", "삽입",
              "고검", "고도", "추도", "명도", "신도", "철검", "실칼", "쇠칼", "둔도", "총칼", "유도", "수인", "동도", "놋칼", "보이",
              "참사", "부도", "자도", "섬도", "엽도", "순도", "우도", "접도", "필", "도도", "곁칼", "폭력", "알맞",
              "칼침", "쌍칼", "검극", "도극", "과검", "섬도", "검순", "엽도", "흉인", "낭도", "박도", "진도", "군도", "동재",
              "맞칼", "창칼", "찬칼", "연도", "진검", "회검", "착수", "살수", "난탕", "철화", "웅검", "독인", "왜검", "왜도", "질싸",
              "관능", "성감", "육감", "절도", "도용", "염탐", "자객", "도청", "밀렵", "사찰", "밀살", "밀통", "책동", "밀부", "암표",
              "밀항", "외응", "투안", "암규", "밀청", "비매", "잠사", "내차", "점시", "규점", "규견", "규시", "밀사", "암매", "섹파",
              "점후", "누고", "잠규", "염찰", "도독", "사간", "암범", "규청", "밀선", "절청", "밀어", "투취", "도답", "도절", "무단",
              "도작", "투작", "도벌", "사여", "균규", "기격", "암상", "통관", "첩적", "상증", "탈방", "상음", "탈선", "영사", "범월",
              "은모", "엄탐", "음계", "투장", "도장", "밀상", "염객", "밀조", "낭사", "노체", "누드", "부치", "펨", "호모",
              "연초", "궐련", "크랙", "골초", "담배", "각초", "성애", "서초", "남초", "잎초", "왜초", "아연", "구초", "악초", "절초",
              "각연", "농초", "매초", "진초", "산초", "신초", "상초", "중초", "행초", "주초", "주연", "썩초", "연주", "탄지", "객초",
              "무초", "용추", "연추", "모야", "엽초", "관연", "봉초", "담부", "뎀베", "담바", "담보", "닢초", "담비", "막대", "돗대",
              "박초", "되초", "딤배", "히로", "담비", "단바", "시로", "헤로", "단배", "말초", "담부", "댓찐", "청초", "황연", "해초",
              "향초", "독초", "영초", "빵", "마약", "대마", "몰핀", "야바", "카트", "댕연", "애편", "애핀", "예펜", "에펜", "공포",
              "아펜", "야편", "에펜", "얘편", "다연", "야펜", "마굴", "참괵", "참두", "난도", "포참", "작참", "경마", "전예",
              "처참", "참획", "부참", "참벌", "책형", "재살", "나가요", "화약", "몰사", "몰살", "전멸", "진몰", "폭약", "병기", "장애",
              "불살", "화초", "간과", "군기", "두무", "무기", "투구", "병구", "도무", "하약", "홰약", "야주", "연화", "화기", "야사",
              "화화", "귀약", "약환", "약포", "화차", "화포", "시너", "니스", "수신", "쌍폐", "자수", "사망", "아사", "객사", "영면",
              "작고", "임종", "익사", "급사", "필사", "물고", "귀천", "동사", "취사", "퇴마", "순연", "피폐", "적멸", "상부", "횡사",
              "즉사", "종사", "전몰", "전사", "비명", "순절", "기사", "사몰", "괴사", "생졸", "임명", "생몰",
              "액사", "찬사", "함몰", "엄사", "갈사", "졸사", "원적", "수요", "폭사", "선서", "흉거", "흉서", "영서", "귀원", "장서",
              "쇠사", "사절", "투사", "광사", "부기", "질사", "중사", "상서", "울사", "원사", "계운", "역사", "돈사", "민사", "요촉",
              "패사", "양륙", "요상", "진사", "요서", "몽사", "쌍망", "상우", "독사", "사세", "폭졸", "참몰", "속사", "문사", "경사",
              "자경", "자자", "직사", "자액", "추사", "병폐", "병몰", "사로", "중상", "장면", "귀토", "화거", "자문", "간소",
              "오사", "하상", "장상", "상상", "오절", "역책", "핍살", "소천", "낙사", "기절", "성불", "선유", "물화", "불귀", "간정",
              "불휘", "사용", "이걸", "저소", "외기", "대로", "동이", "이만", "우고", "지소", "니미", "이사", "액변", "속된", "유혹",
              "적보", "공사", "분즙", "방분", "경변", "혈분", "혈변", "수설", "단생", "신분", "의전", "인상", "정한", "치가", "마땅",
              "쾌락", "고합", "도주", "돌아", "라구", "산하", "상위", "차단", "고미", "고민", "쳐", "농아", "꼽추", "쾌감", "헨플",
              "척이", "맹자", "누배", "몽고", "융질", "구배", "좌객", "벽자", "삼사", "초요", "맹안", "귀배", "곱사", "사주",
              "사키", "이우", "수라", "하니", "경우", "가배", "성수", "한일", "아비", "적인", "주파",
              "중", "로소", "절하", "전인", "서나", "서손", "무부", "만희", "서패", "고2", "고1", "서제",
              "세요", "요자", "이불", "장자", "해주", "고3", "고종", "금한", "나기", "누구", "다리", "도가", "고호", "소생",
              "동안", "망하", "서생", "서자", "지추", "이정", "계모",
              "단사", "화소", "만부", "다사", "말도", "은사", "성해", "고이", "여공", "에미", "어미", "서이", "도기", "두전",
              "서로", "애기", "가수", "서모", "하신", "배우", "고일", "처자", "처녀", "아이", "이세", "과비", "가동", "가예", "제인",
              "시노", "석가", "시부", "이나", "테이", "가부", "다자", "고의", "여자", "남자", "에자", "사생", "백수", "고인", "예쁜",
              "고조", "향기", "다니", "가기", "어시", "각하", "시다", "유생", "유가", "유자", "의자", "의매", "가적", "수록", "표적",
              "게시", "미지", "가비", "관비", "가직", "하지", "수하", "만신", "일신", "전신", "적자", "서대", "스님", "사범", "사부",
              "존사", "사군", "악사", "시승", "함장", "현사", "망사", "상사", "선사", "엄사", "부사", "본사", "응사", "구사", "은부",
              "삼엄", "스승", "부자", "훈인", "노사", "양친", "노친", "육친", "개비", "계부", "의부", "양부", "가친", "자부", "의모",
              "엄부", "가군", "망부", "이인", "생부", "친부", "생모", "친모", "야야", "노부", "악부", "병부", "실부", "실모", "기로",
              "가존", "부공", "후모", "일상적인", "옆모습", "여모", "세우고",
              "가엄", "엄군", "부조", "세부", "대인", "신체", "가아", "망자", "폭발", "에", "서",
              "하", "뿐", "여", "외설", "설어", "어", "야싸", "만냥", "콤돔", "썰툰", "핑두", "영양",
              "옥링", "순", "보", "팸", "머니", "숙한", "제부", "내돈내산", "추천", "효능",
              "만족", "최저가", "좋아요", "비싸다", "싫어요", "효과", "아름다운", "사랑스러운", "이후", "부분", "초점", "멋진", "기준",
              "성인용", "성기구", "성생활", "성도구", "성용품", "권장", "갈수",
              "걸림", "결핍", "그럼", "기에", "나때", "내는", "넘어", "네요", "놓치", "먹",
              "따라", "가능", "되", "대", "들어", "들었", "들을", "하나", "창피해", "야오이", "학생", '중1', '중2', '중3',
              "좋습니다", "주세요", "하세요", "천거", "드립니다", "돼", "발라", "넣어", '후퇴', '활발', '혹은',
              '구건', '과전', '특정', '추진', '쳐줘', "할복", '됩니다', '겁니다', '같습니다', '드릴게요', '세', '장례', '습니다',
              '처하', '주중', '나이', '해새', '함이', '한변', '개씩', '각지', '가편', '필요', '펼쳐', '주게',
              '전적', '전문', '저희', '있어', '인근', '이처', '이죠', '무슨', '맞이', '려고', '떠나', '원인', '외롭', '될때',
              '동을', '데에', '다녀', '오랜', '얻어', '어나', '야추', '않게', '심한', '성으', '빠른', '빠르', '분한', '부터',
              '보입', '변화', '때는', '과에', '고쳐', '늦은', '는지', '느슨', '뇌가', '높이', '내용', '날이', '다열',
              '리게', '만히', '방출', '분의', '어릴', '언제', '요인', '음의', '인까', '있지', '자가', '작은', '될수', '내',
              '정확', '주요', '주의', '하기', '한계', '할이', '해내', '근데', '투입', '되다', '써서', '하는데', '하는일', '수있다',
              '당일', '하더라도', '없이', '줘서', '이렇게', '됐다', '없다', '자내', '원으', '가락을', '가슴이', '거라', '결과가',
              ...
              '정기적', '직이', '타날', '걸려', '고페', '그린', '기한', '날씨가', '로리타', '직접', '또는', '살기', '매우',
              '남을', '남중', '넓다', '넓어', '넓어서', '다운이', '던데', '된다', '따뜻한', '리를', '반이', '볼게', '분들', '분위기',
              '새벽', '세게', '수령', '에앞', '옆쪽', '오히려', '와서', '요해', '우선', '위기의', '이는', '재밌게', '및', '골치',
              '전체', '좋은', '지점', '쫓기', '차분한', '천천히', '최장', '편안', '한데', '한분', '노예', '그', '크', '거', '애',
              'zon', '가늘', '가볍게', '감한', '같다고', '개인', '것이', '게가', '겠다', '고말', '그렇듯', '근처에',
              '나란', '나오면', '나중에', '남겨', '늘려', '니파', '다추', '다행이', '됐고', '되더', '든다', '따뜻하', '똑같이', '리미',
              '마음만', '마지막', '많은것', '먼저', '무던한', '무욕', '박에', '번째', '본래의', '비는', '뽑아', '서아',
              ...
              '했다', '효율', '힘들어', '힙한', '되어', '나트', '증가', '참여', '00', '만성',
              ...
              '이곳', '저의', '좋으', '타일을', '합리적', 'ㄱㄱ', '훌륭한', '꾸준히', '가어', '경솔', '귀한', '눈앞에', '달이', '되나',
              '때도', '뜻밖의', '무서', '미래의', '벌어', '생긴', '스럽게', '실상', '않아도', '었다', '은근', '의미', '의지가', '이미',
              '임지', '책임', '초1', '초2', '초3', '초4', '초5', '초6', '추측', '트라', '할만', '할수록', '습관이', '가줄', '개설', '검색어',
              '결국', '그를', '느냐', '다각', '다룬', '댓글', '되겠어', '때에', '를살', '모으', '목적',
              '반대로', '사용자', '솔직히', '시장에', '아래', '여겨', '여기', '여기를', '왼쪽', '유입', '의주', '이웃',
              '저는', '조회수', '지털', '친해', '팁이', '파이가', '하면되', '가결', '가득한', '감정이',
              '강을', '같네', '것도', '것은', '게으른', '격하', '결여', '곁들인', '관련', '그만큼', '그분', '그에', '꼬물', '끊고',
              '나라는말', '낫다', '내릴', '내블로그', '내에서', '내용은', '네이버에', '높다', '느끼는', '느릿', '다네이버', '닫는',
              '담을', '더위', '돼기', '돼야', '되는것', '되지', '듣고', '들인', '로추', '류요', '많다', '머물', '멍한', '며미', '목하',
              '바로키', '방금', '배워', '병을', '보내세요', '분문', '사는', '사람이', '삶에', '상위노출', '슬픔에', '습득', '시서', '시청',
              '신중', '안에다', '어다', '어떤경우', '어려워', '어르', '에대한', '에들', '에유', '여뉴', '여이', '예민하게', '와함께', '완료',
              '완벽', '욱하는', '울하', '워우', '원래', '위해서', '유난', '의외로', '이것', '이내에', '이상을', '이어짐', '읽었다', '있는지',
              '재방', '재의', '저하', '정신적', '제잘', '줄고', '지닌', '챙겨', '충분히', '친구가', '침에', '커뮤', '판박', '회신',
              '관이', '그러면', '기각', '내거', '누구든', '더많은', '더부룩한', '바뀐', '방해', '불안하게', '스처', '쓸데없는', '안돼', '온전한',
              '전책', '절로', '정으', '천재지변', '큰힘', '한달', '함께극복', '가벼운', '가생', '간절', '감정의', '같은',
              '게나', '겠습니다', '견뎌', '고식', '고퇴', '과지', '관계가', '관심이', '극의', '긍정적', '기르', '나느', '나라의', '놓고', '놓는',
              '느려', '는대', '님이', '답답하고', '데가', '도와주는', '도착해', '동작을', '되길', '되도록', '된다면', '드시다', '똑바로', '먹고',
              '무엇을', '무엇인가', '바랍니다', '반드시', '받는데', '발의', '변화가', '보인다', '봅니다', '봤어요', '부정적인', '분기',
              '불쾌', '사회부', '사회적', '살다보면', '생활의', '스유', '아칭', '안되', '안됨', '알맞은', '애는', '어려울때', '어려움', '어렵고',
              '없음', '여간', '여어', '여주고', '와같은', '와의', '울때', '으키', '을용', '의불', '의집', '인스트', '일관', '일반인',
              '있는것', '있음', '잊는', '잦은', '저히', '적갈', '적절한', '전후의', '좋아한', '증식', '청함', '체계적인', '최소', '출수', '충분한',
              '코로나이', '포함', '할수있는', '함께한', '해봐', '햇볕을', '현저', '화와', '흔한', '흥미를',
              ...
              '힘들게', '힘들다', '어머', '붙여', 'ㅎㅎ', '레즈', '네시', '빠짐', '해줄', '개해', '이번달', '특별한', '부산에', '드디어',
              ...
              '네이버스', '알수없는', '나의가치', '기도하다', '가볼만한', '가워', '가지를', '가펼', '간곳', '갖기', '개가', '걸까', '걸보',
              ...
              '영기', '영하의', '다', '요저', '우리의', '우차', '운하', '울을', '웃도', '원의중', '육관', '의빙', '이금', '이런게', '이빠',
              ...
              '끓여', '내스', '당선', '데캡', '드베', '등등등', '때문이다', '라변', '로화', '린아이', '메워', '무엇보다', '문앞에', '게모', '실물',
              ...
              '풍성한', '형의', '게세', '금네이버', '네이버카', '로그인후', '리널', '바보야', '부과', '세자', '인변', '정당', '폭탄',
              ...
              '대안', '대하여', '되기전에', '무늬만', '버팀', '서도고', '신뢰성', '이B', '잠재적인', '저렴한', '적정성', '중단', '중으로', '징역형', '최악의',
              '페에', '공가', 'ero', 'IMF', '개국', '개수', '건거', '게돈', '게차', '겨냥', '딸딸이',
              '고객님', '공정위', '권보', '귀하의', '금리동결', '금리역전', '금리인상', '젖꼭지', '자기위로',
              '금융위기', '까닭은', '껑충', '끈적', '날아간다', '남성고', '넓히고', '노동절',
              ...
              '꿰뚫고', '개편', 'I의', '갑지', '과하마', '깜찍한', '단단한',
              '만갤', '만화소', '맡긴', '매력적인', '멘붕', '면갤', '물가상승', '붕이',
              '블랙블루', '뿐입니다', '상승률', '스간', '슬하', '실업률', 'ㅇㅇ', '여약', '연준', '영연',
              '올때', '유행하는', '이폰SE', '이폰X', '제롬파월', '지식의', '진짜', '차건',
              '차이점', '참아', '채수', '크노', '탄한', '터리', '판매량', 'ㅎㅇ', '한게임플',
              '한손에', '휴예', '국매', '기뻐', '깜찍한', '단단한', '만갤', '매력적인',
              '모을', '블랙블루', '뿐입니다', '성갤', '스갤', '스다', '압승',
              '약간의', '약자', '오래지', '외워', '월등히', '중학교', '줬다',
              '진지글', '한양이', '히갤', '같음', '개랑', '겁나', '것다', '게야', '고ㅈ', '군더더기',
              ...
              "힣"]  # 체크할 단어 리스트 (꼭! 힣 앞에 단어 추가)

word_list3 = ["굉장", "엄청", "훨씬", "너무", "정말", "아주", "제일", "후기", "리뷰", "합격", "무료", "순위", "해결", "100%",
              "가장", "완전", "안전", "만족", "최고", "게중", "최초", "대단", "무조건", "무척", "젤", "강추", "추천", "1위", "1등",
              "보장", "대박", "베스트", "되게", "훌륭한", "워낙", "진짜", "힣"]  # 체크할 단어 리스트 (꼭! 힣 앞에 단어 추가)

word_listf = ['쌍검', '총칼', '참사', '박도', '진검', '독인', '질싸', '염탐', '도청', '사찰', '책동',
...
base64ApiKey = getBase64Str('live_sk_YPBal2vxj81pRDmNKZKr5RQgOAND:')  # atech001 test apiKey
clientKey = 'live_ck_N5OWRapdA8dEMgaZw6n3o1zEqZKL'  # atech001 test clientKey
...
def index():
    ...
    if DB.tokencheck(token=token, id=id) == False:
        return redirect(url_for("logout"))
    else:
        if "id" in session and DB.index(id):
            user = session["id"]
        elif "id" in session and DB.index(id) == False:
...
def pay():
    id = session.get("id")
    if "id" in session and DB.index(id) == False:
        user = session["id"]
    elif "id" in session and DB.index(id):
    ...
    amount1 = 39000
    amount2 = 89000
    orderId = "paymentlive" + str(random.random() * 10000000)[0:8]
    return render_template('/pay.html', user=user, id=id, orderId=orderId, amount0=amount0, amount1=amount1,
                           amount2=amount2)


@app.route("/paycheck/success", methods=['GET', 'POST'])
def success():
    id = session.get("id")
    parameters = request.args.to_dict()
    rcv_paymentKey = parameters['paymentKey']
    rcv_orderId = parameters['orderId']
    rcv_amount = parameters['amount']

    resultJson = getPayment(rcv_paymentKey, rcv_orderId, rcv_amount, base64ApiKey)
    jsonObject = json.loads(resultJson.text)
    if resultJson.status_code == 200:
        isSuccess = True
    else:
        isSuccess = False
    orderName = jsonObject.get("orderName")
    method = jsonObject.get("method")
    resultPaymentKey = jsonObject.get("paymentKey")
    ...
    if rcv_amount == "39000":
        useday = 10
    elif rcv_amount == "89000":
        useday = 30
    else:
        useday = 1
    DB.pay(startdate=startdate, useday=useday, id=id)

    return redirect(url_for("index", resultJson=resultJson, orderName=orderName, method=method,
                            isSuccess=isSuccess, resultPaymentKey=resultPaymentKey))


@app.route("/paycheck/fail", methods=['GET', 'POST'])
def fail():
    parameters = request.args.to_dict()
    rcv_paymentKey = parameters['paymentKey']
    rcv_orderId = parameters['orderId']
    print(rcv_paymentKey, rcv_orderId)
    return redirect(url_for("pay"))


@app.route("/paycheck/cancel", methods=['GET', 'POST'])
def cancel():
    parameters = request.args.to_dict()
    rcv_paymentKey = parameters['paymentKey']
    resultJson = getCancel(rcv_paymentKey, base64ApiKey)
    return redirect(url_for("pay", resultJson=resultJson, paymentKey=rcv_paymentKey))
...
def login_done():
    ...
    if DB.login(id, pwd):
        session["id"] = id
        token = random.uniform(0, 100)
        session["token"] = token
        DB.token(id=id, token=token)
        return redirect(url_for("index"))
    else:
...
def signup_done():
    id = request.args.get("id")
    pwd = request.args.get("pwd")
    pwdcheck = request.args.get("pwdcheck")
    ...
    if DB.signup(id=id, pwd_hash=pwd_hash, name=name, blogid=blogid,
                 tel=tel, startdate=startdate, useday=useday, token=token):
        flash("회원가입 완료")
        return redirect(url_for("login"))
...
def rank():
    checkID = "GX50WDWi3sC25DLn5E6B"
    checkKEY = "lBU2uN509y"

    client_id = checkID
    client_secret = checkKEY
    ...
    if request.method == 'POST':
        ...
        if DB.tokencheck(token=token, id=id) == False:
            ...
            try:
                ...
                blinklist = []
                myblinklist = []
                kwd = request.form['kwd']
                encText = par.quote(kwd)
                id = request.form['blogid']
                url = "https://openapi.naver.com/v1/search/blog?query=" + encText + '&display=100' + '&start=1'
                ...
                if (rescode == 200):
                    ...
                    for i in range(100):  ### 5개만 확인 (이후 100개로 변경 필요) ###
                        blog = []
                        myblog = []
                        blink = []
                        myblink = []
                        ...
                        num += 1
                        title = (items[i]['title'].replace('<b>', '').replace('</b>', '')).replace('&amp;',
                                                                                                   '&')  # 타이틀 뽑기
                        link = (items[i]['link'])  # 링크 뽑기
                        date = (items[i]['postdate'])  # 작성 날짜 뽑기

                        for source in [num, date, title]:
                            blog.append(source)

                        if id in link:  # 링크랑 아이디 매칭
                            for mysource in [num, date, title]:
                                myblog.append(mysource)  # 매칭된 숫자 출력

                        bloglist.append(blog)
                        blinklist.append(blink)
                        if len(myblog) > 0:
                            mybloglist.append(myblog)
                            myblinklist.append(myblink)

                return render_template('rank.html', user=user, bloglist=bloglist, mybloglist=mybloglist)

            except Exception as e:
                return redirect(url_for("rank"))

    return render_template('rank.html', user=user)
...
def check():
    ...
    if request.method == 'POST':
        ...
        if DB.tokencheck(token=token, id=id) == False:
            ...
            try:
                if 'blogurl' in request.form:
                    link = request.form['blogurl']
                    if 'm.blog' in link:
                        code = requests.get(link).text
                        soup = BeautifulSoup(code, "html.parser")
                        linea = soup.select_one(
                            "div.se-main-container")
                        linea1 = linea.text.replace("\n", "")
                        linea2 = str(linea1)
                    ...
                    for word in word_list1:
                        count = line2.count(word)  # 해당 단어 개수로 변경
                        if int(count) > 0:  # 정수형으로 변경
                            penlist1.append(f"{word}: {count}")
                            continue

                        elif word == "힣":  # END 나오면 끝
                            break
                    ...
                    for key, value in count.items():
                        if value >= 2:
                            mainlist.append(f"{key}: {value}")

                    return render_template('check.html', user=user, forth=forth, penlist1=penlist1, penlist3=penlist3,
                                           penlistf=penlistf, mainlist=mainlist, line2=line2)

                elif 'blogtext' in request.form:
    ...
    if request.method == 'POST':
        ...
        if DB.tokencheck(token=token, id=id) == False:
            ...
            while True:
                ...
                rink = urllib.request.Request(url)
                rink.add_header("X-Naver-Client-Id", client_id)
                rink.add_header("X-Naver-Client-Secret", client_secret)
                response = urllib.request.urlopen(rink)
                rescode = response.getcode()
                if (rescode == 200):
                    response_body = response.read()
                    result = response_body.decode('utf-8')
                    ...
                    for item in items:
                        try:
                            link = item['link']  # 링크 갖고 오기
                            link = link.replace('blog', 'm.blog')  # 모바일 링크로 변환
                            link = link.replace('?Redirect=Log&logNo=', '/')  # 모바일 링크 정리
                            code = requests.get(link).text
                            soup = BeautifulSoup(code, "html.parser")
                            linea = soup.select_one(
                                "div.se-main-container")
                            ...
                            linea2 = str(linea1)
                            output_total += linea2
                            # print("해당 키워드의 {}번째 블로그를 크롤링 중입니다.".format(blognum))
                            blognum += 1
                        except Exception as e:
                            continue
                ...
                for key, value in count.items():
                    if value >= 2:
                        # print(f"{key} : {value}")
                        keyword.append(f"{key}: {value}")

                return render_template('mining.html', user=user, keyword=keyword)
    return render_template('mining.html', user=user, id=id)
